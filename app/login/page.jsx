    ...
    return (
        <section className='bg-[#f8f9fb] h-screen flex justify-center items-center'>
            <div>
                ...
                <form className='w-[450px] p-8 shadow-md rounded-2xl bg-[#ffffff]'>
                    <div className='pb-3'>
                        <label className='pb-2 text-sm font-medium block'>Email Address</label>
                        <input className='w-full border px-3 py-2 rounded-lg focus:outline-none' type="email" placeholder="Email Address" />
                    </div>
                    <div className=''>
                        ...
                        <div className='flex justify-between items-center w-full border px-3 py-2 rounded-lg'>
                            <input className=' focus:outline-none' type={`${show ? 'text':'password'}`} placeholder="Password" />
                    ...
                    <button className='w-full mt-6 py-3 bg-[#17494d] text-white rounded-lg '>Sign In</button>
                </form>
            </div>
        </section>
    );
